...
public class Testing {
    ...
    void Cotizar(){
        //Se realiza una busqueda sobre AstroGrow
    ...
    void Manuales(){
        //se conecta y busca el manual de instalación.
        driver.findElement(By.id("nav-tutoriales")).click();
        driver.findElement(By.xpath("//*[@id=\"nav-docs-tutoriales\"]")).click();
